/*==========================================================================*/
// $Id: dei_sc_icon_trigger.c 33256 2015-08-19 12:44:53Z martin.bouchard $
/*==========================================================================*/
...
{        
    ...
    dei_sc_info_set( DEI_SC_INFO_SENSOR3_TRIGGERED     , !!(trig&NOTIFY_PLD_TRIG_S3  )) ; 
		...
		if( !!(trig&NOTIFY_PLD_TRIG_CUSTOM) )
		{
			set_ss_custom_trigger_zone( TRUE );
		}
    dei_sc_tx_flush();
    
	return dei_sc_tx( DEI_SC_ACK_ALARM_TRIGGER_EVENT , DEI_SC_PAGGING_TX , 100 ) ; 
}
