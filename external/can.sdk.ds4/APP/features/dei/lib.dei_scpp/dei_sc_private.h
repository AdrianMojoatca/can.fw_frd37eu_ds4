...
{    									   
    ...
    DEI_SC_PAGGING_TX     ,       
	  DEI_SC_STANDBY_TX     ,  // like DEI_SC_NORMAL_TX but also set standby bit (keep HHU listening)
...
typedef enum
{
    ...
    DEI_SECURITY_DISARMED_VALET_ON 						=0x05,
	  DEI_SECURITY_ARMED_RS_VALET_ON 						=0x06,
	  DEI_SECURITY_DISARMED_RS_VALET_ON  				=0x07,
	  DEI_SECURITY_ARMED_COMBO_VALET_ON 				=0x08,
	  DEI_SECURITY_DISARMED_COMBO_VALET_ON  		=0x09
...
typedef enum
{
    DEI_SECURITY_ARM_STATUS_BIT            						=0x01, 
    DEI_SECURITY_STEALTH_STTAUS_BIT        						=0x02, 
    DEI_SECURITY_VALET_STATUS_BIT         						=0x04,
	  DEI_SECURITY_RS_VALET_STTAUS_BIT 						      =0x06,
	  DEI_SECURITY_COMBO_VALET_STATUS_BIT       				=0x08,

}Dei_Icon_Security_Bits;
...
//                                         bit index msb  bit index lsb
    ...
    DEI_SC_INFO_SECURITY                  = (21u << 8) | ( 18 ),       
    DEI_SC_INFO_DOOR_STATUS               = (22u << 8) | ( 22 ),
    DEI_SC_INFO_DOOR_TRIGGER_BYPASS       = (23u << 8) | ( 23 ),
    DEI_SC_INFO_DOOR_TRIGGERED            = (24u << 8) | ( 24 ),        
    DEI_SC_INFO_HOOD_STATUS               = (25u << 8) | ( 25 ),
    DEI_SC_INFO_HOOD_TRIGGER_BYPASS       = (26u << 8) | ( 26 ),
    DEI_SC_INFO_HOOD_TRIGGERED            = (27u << 8) | ( 27 ),
    DEI_SC_INFO_TRUNK_STATUS              = (28u << 8) | ( 28 ),
    DEI_SC_INFO_TRUNK_TRIGGER_BYPASS      = (29u << 8) | ( 29 ),
    DEI_SC_INFO_TRUNK_TRIGGERED           = (30u << 8) | ( 30 ),
    DEI_SC_INFO_IGNITION_STATUS           = (31u << 8) | ( 31 ),
    DEI_SC_INFO_IGNITION_TRIGGER_BYPASS   = (32u << 8) | ( 32 ),
    DEI_SC_INFO_IGNITION_TRIGGERED        = (33u << 8) | ( 33 ),        
    DEI_SC_INFO_SENSOR1_STATUS            = (34u << 8) | ( 34 ),
    DEI_SC_INFO_SENSOR1_TRIGGER_BYPASS    = (35u << 8) | ( 35 ),
    DEI_SC_INFO_SENSOR1_WARNING_BYPASS    = (36u << 8) | ( 36 ),
    DEI_SC_INFO_SENSOR1_NPC               = (37u << 8) | ( 37 ),
    DEI_SC_INFO_SENSOR1_TRIGGERED         = (38u << 8) | ( 38 ),
    DEI_SC_INFO_SENSOR1_ICON              = (41u << 8) | ( 39 ),
    DEI_SC_INFO_SENSOR2_STATUS            = (42u << 8) | ( 42 ),
    DEI_SC_INFO_SENSOR2_TRIGGER_BYPASS    = (43u << 8) | ( 43 ),
    DEI_SC_INFO_SENSOR2_WARNING_BYPASS    = (44u << 8) | ( 44 ),
    DEI_SC_INFO_SENSOR2_NPC               = (45u << 8) | ( 45 ),
    DEI_SC_INFO_SENSOR2_TRIGGERED         = (46u << 8) | ( 46 ),
    DEI_SC_INFO_SENSOR2_ICON              = (49u << 8) | ( 47 ),
    DEI_SC_INFO_SENSOR3_STATUS            = (50u << 8) | ( 50 ),
    DEI_SC_INFO_SENSOR3_TRIGGER_BYPASS    = (51u << 8) | ( 51 ),
    DEI_SC_INFO_SENSOR3_WARNING_BYPASS    = (52u << 8) | ( 52 ),
    DEI_SC_INFO_SENSOR3_NPC               = (53u << 8) | ( 53 ),
    DEI_SC_INFO_SENSOR3_TRIGGERED         = (54u << 8) | ( 54 ),
    DEI_SC_INFO_SENSOR3_ICON              = (57u << 8) | ( 55 ),
    DEI_SC_INFO_SENSOR_BYPASS_LEVEL       = (61u << 8) | ( 58 ),
    DEI_SC_INFO_SENSOR1_LEVEL             = (65u << 8) | ( 62 ),    
    DEI_SC_INFO_SMART_START_LOW_TEMP      = (69u << 8) | ( 66 ),
    DEI_SC_INFO_SMART_START_HIGH_TEMP     = (73u << 8) | ( 70 ),
    DEI_SC_INFO_TIMER_MODE_STARTS_COUNT   = (77u << 8) | ( 74 ),
    DEI_SC_INFO_TIMER_MODE_STARTS_PERIOD  = (81u << 8) | ( 78 ),    
    DEI_SC_INFO_AUXCH2_STATUS             = (82u << 8) | ( 82 ),
    DEI_SC_INFO_AUXCH2_ICON               = (86u << 8) | ( 83 ),    
    DEI_SC_INFO_AUXCH3_STATUS             = (87u << 8) | ( 87 ),
    DEI_SC_INFO_AUXCH3_ICON               = (91u << 8) | ( 88 ),
    DEI_SC_INFO_AUXCH4_STATUS             = (92u << 8) | ( 92 ),
    DEI_SC_INFO_AUXCH4_ICON               = (96u << 8) | ( 93 ),
    DEI_SC_INFO_AUXCH5_STATUS             = (97u << 8) | ( 97 ),
    DEI_SC_INFO_AUXCH5_ICON               = (101u<< 8) | ( 98 ),    
    DEI_SC_INFO_AUXCH6_STATUS             = (102u << 8)| ( 102),    
    DEI_SC_INFO_ERROR                     = (107u<< 8) | ( 103),
    DEI_SC_INFO_VECHICLE_TEMP             = (115u<< 8) | ( 108),
    DEI_SC_INFO_LED_FLASH		              = (122u<< 8) | ( 115),
    DEI_SC_INFO_BIT_COUNT                 = 116
...
//#if BUILD_NGMM == 1
    DEI_SC_BUTTON_HOME_VALET                =   0x00E6-0x00A0 ,  //conflict with BUTTON_PROGAMMING_DONE?
    DEI_SC_BUTTON_COMBO_VALET               =   0x00E7-0x00A0 ,
    DEI_SC_BUTTON_TOGGLE_LED                =   0x00E8-0x00A0 ,  //used in AS, other usage for NGMM
    DEI_SC_BUTTON_START_VALET               =   0x00E9-0x00A0 ,
    DEI_SC_BUTTON_SWITCH_PATTERN            =   0x00EA-0x00A0 ,
		
    DEI_SC_BUTTON_COUNT                     =   0x00EB-0x00A0 ,
//#else
...
typedef enum
{
    ...
    DEI_SC_NGRF_MODE_ZAP  ,
    DEI_SC_NGRF_MODE_TACHO_DELETE  ,
...
#define	DEI_SC_VRTC_TIMEOUT_FIRST_RF_UPDATE		VRTC_1SEC*3		//3 seconds for first update
#define	DEI_SC_VRTC_TIMEOUT_EXT_RF_UPDATE		VRTC_1SEC*15		//15 seconds for extended update
...
Boolean             dei_sc_icon_standby                     ( void );

Boolean             dei_sc_icon_runtime_check               ( Notify_Pld_Runtime runtime );
Boolean             dei_sc_icon_runtime_update              ( Notify_Pld_Runtime runtime );
...
Boolean 			dei_sc_led_flash						( Notify_Pld_Led led );
...
Boolean				dei_sc_icon_rs_valet_on(void);
Boolean				dei_sc_icon_rs_valet_off(void);
Boolean 			dei_sc_icon_convenience_alert (void);
...
void dei_sc_set_hhu_num( UInt8 hhu_num );
...
extern Timeout 									dei_sc_timeout_sensor_adjust			 ;
extern UInt32										dei_led_pattern											;
extern Vrtc 										dei_sc_sensor_adjust_mode_vrtc			;
extern unsigned                 dei_sc_cmd_release_tmr_cnt          ;
extern UInt8					dei_sc_sensor_adjust_hhu					 ;
extern UInt8 					dei_sc_alert_event;
extern Boolean 					dei_sc_ext_page_update;
extern System_Type              scpp_system_type;
extern UInt8			dei_sc_hhu_num;
