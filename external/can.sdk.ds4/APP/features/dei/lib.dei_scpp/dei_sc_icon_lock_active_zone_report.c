...
Boolean  dei_sc_icon_active_zone( Notify_Pld_Zone_Report zone )
{
	...
	dei_sc_info_set( DEI_SC_INFO_SENSOR3_STATUS    , !!(zone & NOTIFY_PLD_ZONE_S3  ) );
#ifdef PLATFORM_933	
	if(ext_sensor_trigger_configured && ext_sensor_trigger_wire_status)
		dei_sc_info_set( DEI_SC_INFO_SENSOR3_STATUS    , TRUE );
#endif	
