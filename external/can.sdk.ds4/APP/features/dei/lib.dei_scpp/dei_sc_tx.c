...
static const Dei_Sc_Ack_Table dei_sc_ack_table[] = 
{
    ...
    /*DEI_SC_ACK_LOCK_WITH_ACTIVE_ZONE_REPORT	*/	 { 0xA3	,	DEI_SC_PLD004     },
    /*DEI_SC_ACK_UNLOCK	                */	 { 0xA4	,	DEI_SC_PLD002     },
    ...
    /*DEI_SC_ACK_REMOTE_START_ON  	            */	 { 0xC0	,	DEI_SC_PLD003     },
    /*DEI_SC_ACK_REMOTE_START_OFF     	        */	 { 0xC1	,	DEI_SC_PLD003     },
    ...
    /*DEI_SC_ACK_CONVENIENCE_ALERT	            */	 { 0xD7	,	DEI_SC_PLD016     }
