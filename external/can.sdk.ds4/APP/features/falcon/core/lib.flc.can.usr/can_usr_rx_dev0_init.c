...
void can_usr_rx_dev0_init( void )
{
    ...
    #if CAN_DEV_0_FT_SW == TRUE    
        can_usr[CAN_DEV_0].can_dev = can_dev_create( CAN_DEV_0 , CAN_DEV_0_BTR   , CAN_DEV_0_TSEG1                 ,\
                                                                 CAN_DEV_0_TSEG2 , CAN_DEV_0_SJW   , CAN_DEV_0_SAM ,\
                                                                 CAN_DEV_0_P0_0_1   );
    #else
        can_usr[CAN_DEV_0].can_dev = can_dev_create( CAN_DEV_0 , CAN_DEV_0_BTR   , CAN_DEV_0_TSEG1                 ,\
                                                                 CAN_DEV_0_TSEG2 , CAN_DEV_0_SJW   , CAN_DEV_0_SAM ,\
    ...
    if( can_usr[CAN_DEV_0].rx_use_buffer )
    {
        can_usr[CAN_DEV_0].rx_pipe = pipe_create( CAN_DEV_0_RX_BUFFER_SIZE , sizeof( struct s_Can_Msg ) );  
