...
/*==========================================================================*/
// $Id: os_private.h 33257 2015-08-19 12:45:49Z martin.bouchard $
/*==========================================================================*/
...
void         os_k_service_pte              (void) ;
void         os_k_service_gte              (void) ;
void         os_k_service_tmr              (void) ;
void         os_k_service_timeslice        (void) ;
...
void         os_kern_null_mem_fail (void * address , UInt16 size_requested) ;
