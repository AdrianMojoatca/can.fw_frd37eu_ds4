...
/*==========================================================================*/
// $Id: dei_ask_handler_irq.c 31193 2015-05-06 17:14:56Z martin.bouchard $
/*==========================================================================*/
...
/*==========================================================================*/
static __inline void dei_ask_bit_time_update_irq_mode(Boolean is_rising_edge);
/*==========================================================================*/
/*                            V A R I A B L E S                             */
/*==========================================================================*/
...
void dei_ask_handler_irq(void) 
{
    ...
    dei_ask.current_timestamp = T3TC;
    
    is_rising_edge = DEI_ASK_EXT_IS_RISING_EDGE();
    
    dei_ask_bit_time_update_irq_mode(is_rising_edge);
...
__inline void dei_ask_bit_time_update_irq_mode(Boolean is_rising_edge)
{
    UInt32 time_diff;
