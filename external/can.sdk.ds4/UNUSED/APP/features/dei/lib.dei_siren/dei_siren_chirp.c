...
/*==========================================================================*/
// $Id: dei_siren_chirp.c 33256 2015-08-19 12:44:53Z martin.bouchard $
/*==========================================================================*/
...
{		
	...
	if( (chirp & DEI_SIREN_ARM) || (chirp & DEI_SIREN_ARM_NOTIFICATION) || (chirp & DEI_SIREN_ZONE_BYPASS) || (chirp & DEI_SIREN_FULL_SILENT_ARM) )
	{
		DEI_SIREN( 20 , 3 , 20 , 1 ) ;		
	}


	if( chirp & DEI_SIREN_DISARM_NO_EVENT )
	{
		DEI_SIREN( 20 , 3 , 20 , 2 ) ;		
	}
	...
	if( chirp & DEI_SIREN_REMOTE_PROGRAMMING_DONE )
	{
