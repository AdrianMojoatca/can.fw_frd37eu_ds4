...
/*==========================================================================*/
// $Id: sys_init_clock.c 33257 2015-08-19 12:45:49Z martin.bouchard $
/*==========================================================================*/
...
#define PLL0_SETUP            1
//#define PLL0CFG_Val           0x00020031							//  for 100 MHz
#define PLL0CFG_Val           0x00020023                // for 72 MHz
#define PLL1_SETUP            0
...
void sys_init_clock (void)
{
    ...
    LPC_SC->FLASHCFG    = FLASHCFG_Val ;			// TODO: need to change value for 100MHz right now value id for 72MHz
    ...
    CCLKCFG     = CCLKCFG_Val ;         /* Setup Clock Divider                */
      ...
      PLLCFG   = PLL0CFG_Val ;
      PLLCON   = 0x01 ;                /* PLL0 Enable                        */
      PLLFEED  = 0xAA ;
      PLLFEED  = 0x55 ;
  
      while (!(PLLSTAT & (1 << 26))) ; /* Wait for PLOCK0                    */
    
      PLLCON   = 0x03 ;                /* PLL0 Enable & Connect              */
      PLLFEED  = 0xAA ;
      PLLFEED  = 0x55 ;
